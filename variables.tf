...
variable "acceleration_status" {
  ...
  validation {
    condition     = var.acceleration_status == null || var.acceleration_status == "Suspended" || var.acceleration_status == "Enabled"
    error_message = "Valid values should be 'Suspended' or 'Enabled'."
  }
}
